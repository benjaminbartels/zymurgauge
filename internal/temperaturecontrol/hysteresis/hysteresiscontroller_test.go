...
const (
	chillingDifferential    = 1.0
	heatingDifferential     = 1.0
...
func TestRunFirstRead(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			ctlr := hysteresis.NewController(thermometerMock, chillerMock, heaterMock, chillingDifferential,
				heatingDifferential, l)
...
func TestRunConsecutiveTemperatureChanges(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "betweenToBetween", temp1: 9.9, temp2: 10.1, chiller1: false, heater1: false, chiller2: false, heater2: false},
		...
		{name: "chillToBetween", temp1: 20, temp2: 9.9, chiller1: true, heater1: false, chiller2: false, heater2: false},
		{name: "chillToHeat", temp1: 20, temp2: 5, chiller1: true, heater1: false, chiller2: false, heater2: true},
		{name: "heatToBetween", temp1: 5, temp2: 10.1, chiller1: false, heater1: true, chiller2: false, heater2: false},
...
func TestChillerCooldown(t *testing.T) {
	...
	ctlr := hysteresis.NewController(thermometerMock, chillerMock, heaterMock, chillingDifferential, heatingDifferential,
		l, cycleOpts, cooldownOpts)
...
func TestRunAlreadyRunningError(t *testing.T) {
	...
	ctrl := hysteresis.NewController(thermometerMock, chillerMock, heaterMock, chillingDifferential,
		heatingDifferential, l)
...
func TestThermometerIsNilError(t *testing.T) {
	...
	ctrl := hysteresis.NewController(nil, chillerMock, heaterMock, chillingDifferential, heatingDifferential, l)
...
func TestActuatorIsNilError(t *testing.T) {
	...
	ctrl := hysteresis.NewController(thermometerMock, nil, nil, chillingDifferential, heatingDifferential, l)
