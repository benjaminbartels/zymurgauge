...
func run(logger *logrus.Logger) error {
	...
	if err := startTemperatureControllerTest(chamberRepo, logger); err != nil {
...
func startTemperatureControllerTest(chamberRepo chamber.Repo, logger *logrus.Logger) error {
	...
	if len(chambers) > 0 {
		...
		createFunc := CreateTemperatureController
